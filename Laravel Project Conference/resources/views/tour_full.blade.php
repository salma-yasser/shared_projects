      ...
      <tr>
        <td width="300" valign="top"><table width="240" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              ...
              <tr>
                <td height="65" valign="top"><img src="image/ht/left_top.gif"></td>
              </tr>
              <tr>
                <td height="35" style="padding-left:20px; border-bottom : 1px solid #dedcdd;"><a href="hotel" class="left">Hotel</a></td>
              </tr>
              <tr>
                <td height="35" style="padding-left:20px; border-bottom : 1px solid #dedcdd;"><a href="tour_half" class="left_on">Optional Tour</a></td>
              </tr>
            </tbody>
          </table>
        ...
        <td valign="top" style="padding-bottom:20px;"><div style="text-align:left;padding-bottom:20px;"><div><img src="image/ht/title_tour.gif" vspace="30"></div>
