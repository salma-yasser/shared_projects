            ...
            <table width="870" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><div style="text-align:left;padding-bottom:20px;"><div><h1 style="font-weight: bold; color: #666;"><span style="color: #0071bc;">Digests</span> Guidelines</h1></div></div></td>
                  </tr>
                </table>
              </td>
            </tr>
             <tr>
                <td align="center" bgcolor="#fff">
                  <div class="digests-box">
                    ...
                    <span class="textbox1">Digests Submission Guidelines</span>
                    <br>
                    ...
                    <div id="digests">
                      <div id="main_links">
                        <div class='wrapper' style="width: 25%;">
                          <ul>
                            <li>
                              <a href='download/ISR19-Digst-Guide.pdf'>
