              ...
              <tr>
                <td height="65" valign="top">
                  <div class="leftMenu">
                    ...
                    <div class="items">
                        <a href="paper_committee" class="item left_on">Papers of Scientific Committee</a>
                    </div>
                    @endif
                    <!-- @if(Auth::user()->id == 2)
                    <div class="items">
            ...
            <table width="870" border="0" cellpadding="0" cellspacing="0">
                ...
                <td height="30" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><div style="text-align:left;padding-bottom:20px;"><div><h1 style="font-weight: bold; color: #666;">
                        <span style="color: #0071bc;">Papers of </span> Scientific Committee
                    </h1></div></div></td>
                  </tr>
                </table>
              </td>
             ...
             <tr>
                <td valign="top">
				  ...
				  function sendComment(paperid) {
                    var name = '<?php echo Auth::user()->fname.' '.Auth::user()->lname?>';
                    var comment = document.getElementById('comment'+paperid).value;
                    if (comment.length == 0) { 
                        return;
                    } else {
                        $.ajax({
                        ...
                        success: function(data) {
                            console.log(data);
                           document.getElementById('new_comment'+paperid).remove();

                                $('#comment_table'+paperid).append('<tr><td width="25%" style="padding:5pt; font-size:12pt;"><center><strong style="font-size:12pt;">'+name+' </strong></center></td><td width="70%"  bgcolor="#FFFFFF" style="padding:5pt 10pt; border-bottom: 3px solid #f5f5f5;">'+comment+'</td><td bgcolor="#FFFFFF" style="padding-right:10pt;border-bottom: 3px solid #f5f5f5;"><span style="color: #00a99d; font-size:11pt;"><center>'+data.updated_at+'</center></span> </td></tr>');
                                $('#comment_table'+paperid).append('<tr id="new_comment'+paperid+'"><td width="25%" style="padding:5pt;"><center><strong style="color: #0071bc; font-size:12pt;">Comment </strong></center></td><td width="70%" bgcolor="#FFFFFF" style="padding:5pt 10pt"><textarea id="comment'+paperid+'" cols="80"></textarea></td> <td bgcolor="#FFFFFF" style="padding-right:10pt"><a onclick="sendComment('+paperid+')" class="button_icems2018"> <span style="color: #ffffff">Save</span> </a></td></tr>');
                        }
                    });
                    }
                } 
                    ...
                    <table width="830" border="0" cellpadding="5" cellspacing="0" style="
                      ...
                      foreach($topic->papers as $paper){
                        if($paper->confirmed == 1){
                          echo '<tr>
                        <td colspan="3"  style="padding:5pt 10pt"><div style="float:left"><span>'.$paper->id.'</span><span class="symposium1"> - </span><span>'.$paper->title.' - </span><span style="color:red">Confirmed</span></div></td>
                      </tr>';
                        }else{
                      echo '<tr>
                      ...
                      <tr id="sym'.$x.'_accept" style="display:none">
                        ...
                        if(Auth::user()->id ==2 || Auth::user()->id ==5 || Auth::user()->id ==36){
