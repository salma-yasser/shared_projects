      ...
      <tr>
        <td width="300" valign="top"><table width="240" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              ...
              <tr>
                <td height="65" valign="top"><img src="..\image\re\left_top.gif"></td>
              </tr>
              <tr>
                <td height="35" style="padding-left:20px; border-bottom : 1px solid #dedcdd;"><a href="signup" class="left_on">Registration</a></td>
              </tr>
            </tbody>
          </table>
        ...
        <td valign="top" style="padding-bottom:20px;"><div style="text-align:left;padding-bottom:20px;"><div><img src="..\image\re\title_registration.gif" vspace="30"></div>
