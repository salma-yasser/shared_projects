                ...
                <td height="65" valign="top">
                  <div class="leftMenu">
                    ...
                    <div class="items">
                        ...
                        <a href="ourpartner" class="item left_on">Our Partner</a>
                    </div>
                  </div>
                </td>
              </tr>
            ...
            <table width="870" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><div style="text-align:left;padding-bottom:20px;"><div><h1 style="font-weight: bold; color: #666;"><span style="color: #0071bc;">Our</span> Partner</h1></div></div></td>
                  </tr>
                </table>
              </td>
            </tr>
