              ...
              <tr>
                <td height="65" valign="top">
                  <div class="leftMenu">
                    ...
                    <div class="items">
                        <a href="login" class="item left_on">Login</a>
            ...
            <table width="870" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><div style="text-align:left;padding-bottom:20px;"><div><h1 style="font-weight: bold; color: #666;"><span style="color: #0071bc;">Login</span></h1></div></div></td>
                  </tr>
                </table>
              </td>
            </tr>
             <tr>
                ...
                <table width="900" border="0" cellspacing="0" cellpadding="0">
                  <form name="login" method="post" action="{{ route('login') }}" onsubmit="return login_check();">
                     {{ csrf_field() }}
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="subtable1_write">
                          <tr>
                            ...
                            <td class="first"><input name="email" type="text" class="hbox" id="email" size="40"></td>
                          </tr>
                          <tr>
                            <td bgcolor="#f8f8f8"><img src="{{URL::asset('image/eyesight/icon_blackbox.gif')}}" width="3" height="3" align="absmiddle"> Password</td>
                            <td><input name="password" type="password" class="hbox" id="password" size="40"></td>
                          </tr>
                          <tr>
                            <td bgcolor="#FFFFFF" style="border-bottom:0;">&nbsp;</td>
                            <td style="border-bottom:0;"><input type="checkbox" name="remember" id="remember" class="img"> Remember Me</td>
                          </tr>
                          <tr>
                            <td colspan="2" align="center" bgcolor="#FFFFFF" style="padding-top:20px;border-bottom:0px">  <input type=image src="{{URL::asset('image/btn/btn_login.gif')}}" class="img" hidefocus><!-- <a href="signup"><img src="{{URL::asset('image/btn/btn_signup.gif')}}" hspace="5"> -->
                            </td>
                          </tr>
                      </table></td>
                    </tr>
                  ...
                  <tr>
                    <td valign="top">※</td>
                            <td height="25" valign="top">If you have not registered your e-mail 
                              address and password yet, please <a href="signup"><span style="color: #E46C0A;font-weight:  bold;">SIGN UP</span></a> first. </td>
                  </tr>
                  <tr style="padding-top:15px;">
                    <td valign="top">※</td>
                    <td valign="top">If you have forgotten your password, please click here! <a href="password/reset"><span style="color: #E46C0A;font-weight:  bold;">RESET PASSWORD</span></a></td>
                  </tr>
                      </table></td>
                    </tr>
                  </form>
